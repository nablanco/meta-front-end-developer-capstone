  ...
  return (
    <footer className="footer" id="footer">
      ...
      <div className='footer-section-container'>
        <section className="footer-subsection-container" id='doormat-navigation'>
          <h3 className='footer-subsection-header'>Doormat Navigation</h3>
          <div className="link-list-container">
            {doormatNavigationLinks.map(navigation => {
              return (
                <HashLink to={navigation.link} className='footer-navigation' key={navigation.name}>{navigation.name}</HashLink>
              )
            })}
          </div>
        </section>
        <section className="footer-subsection-container" id='contact'>
          ...
          <div className="link-list-container">
            {contactLinks.map(contact => {
              return (
                <HashLink to={contact.link} className='footer-navigation' key={contact.name}>{contact.name}</HashLink>
              )
            })}
          </div>
        </section>
        <section className="footer-subsection-container" id='social-media'>
          ...
          <div className="link-list-container">
            {socialMediaLinks.map(socialMedia => {
              return (
                <HashLink to={socialMedia.link} className='footer-navigation' key={socialMedia.name}>{socialMedia.name}</HashLink>
              )
            })}
          </div>
        </section>
